"""
Django settings for expenzo_project project.
...
INSTALLED_APPS = [
    ...
    'apps.expenzo.apps.ExpenzoConfig',
]
...
# HTTPS & Security Headers (Enforced when DEBUG is False)
if not DEBUG:
...
DEFAULT_FROM_EMAIL = os.environ.get('EMAIL_HOST_USER', 'noreply@expenzo.local')
